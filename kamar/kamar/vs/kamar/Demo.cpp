...
void Demo::BuildColoredCube() {
	...
	float vertices[] = {
		...
		// front
		-0.7, -0.5, 0.5, 		0.0f,  0.0f,  1.0f,  // 0
		 0.7, -0.5, 0.5, 	 0.0f,  0.0f,  1.0f,   // 1
		 0.7,  0.5, 0.5, 	0.0f,  0.0f,  1.0f,   // 2
		-0.7,  0.5, 0.5, 	 0.0f,  0.0f,  1.0f,  // 3

		// right
		0.7, -0.5,  0.5, 	1.0f,  0.0f,  0.0f,  // 4
		0.7, -0.5, -0.5, 	1.0f,  0.0f,  0.0f,  // 5
		0.7,  0.5, -0.5, 	1.0f,  0.0f,  0.0f,  // 6
		0.7,  0.5,  0.5, 	1.0f,  0.0f,  0.0f,  // 7

		// back
		-0.7,  -0.5, -0.5, 	0.0f,  0.0f,  -1.0f, // 8 
		 0.7,  -0.5, -0.5, 	0.0f,  0.0f,  -1.0f, // 9
		 0.7,   0.5, -0.5, 	0.0f,  0.0f,  -1.0f, // 10
		-0.7,   0.5, -0.5, 	0.0f,  0.0f,  -1.0f, // 11

		// left
		-0.7, -0.5, -0.5, 	-1.0f,  0.0f,  0.0f, // 12
		-0.7, -0.5,  0.5, 	-1.0f,  0.0f,  0.0f, // 13
		-0.7,  0.5,  0.5, 	-1.0f,  0.0f,  0.0f ,// 14
		-0.7,  0.5, -0.5, 	-1.0f,  0.0f,  0.0f ,// 15

		// upper
		 0.7, 0.5,  0.5, 		0.0f,  1.0f,  0.0f,   // 16
		-0.7, 0.5,  0.5, 		0.0f,  1.0f,  0.0f,  // 17
		-0.7, 0.5, -0.5, 		0.0f,  1.0f,  0.0f,  // 18
		 0.7, 0.5, -0.5, 		0.0f,  1.0f,  0.0f,   // 19

		// bottom
		-0.7, -0.5, -0.5, 		0.0f,  -1.0f,  0.0f, // 20
		 0.7, -0.5, -0.5, 		0.0f,  -1.0f,  0.0f,  // 21
		 0.7, -0.5,  0.5, 		0.0f,  -1.0f,  0.0f,  // 22
		-0.7, -0.5,  0.5, 		0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildColoredFoto() {
	float vertices[] = {
		// format position, tex coords
		// front
		-0.7,  0.5, 0.1,  0.0f,  0.0f,  1.0f,  // 0
		 0.7,  0.5, 0.1,   0.0f,  0.0f,  1.0f,   // 
		 0.7,  1.5,   0.1, 0.0f,  0.0f,  1.0f,   // 2
		-0.7,  1.5,   0.1,  0.0f,  0.0f,  1.0f,  // 3

		// right
		0.7,  0.5,  0.1,  1.0f,  0.0f,  0.0f,  // 4
		0.7,  0.5, -0.1,  1.0f,  0.0f,  0.0f,  // 5
		0.7,  1.5, -0.1,1.0f,  0.0f,  0.0f,  // 6
		0.7,  1.5,  0.1,1.0f,  0.0f,  0.0f,  // 7

		// back
		-0.7,  0.5, -0.1,  0.0f,  0.0f,  -1.0f, // 8 
		 0.7,  0.5, -0.1,  0.0f,  0.0f,  -1.0f, // 9
		 0.7,  1.5, -0.1, 0.0f,  0.0f,  -1.0f, // 10
		-0.7,  1.5, -0.1, 0.0f,  0.0f,  -1.0f, // 11

		// left
		-0.7,  0.5, -0.1, -1.0f,  0.0f,  0.0f, // 12// 12
		- 0.7,  0.5,  0.1, -1.0f,  0.0f,  0.0f, // 13// 13
		- 0.7,  1.5,  0.1,- 1.0f,  0.0f,  0.0f, // 14, // 14
		- 0.7,  1.5, -0.1,- 1.0f,  0.0f,  0.0f, // 15, // 15

		// upper
		 0.7, 1.5,  0.1,  0.0f,  1.0f,  0.0f ,  // 16 // 16
		- 0.7, 1.5,  0.1,  0.0f,  1.0f,  0.0f,  // 17// 17
		- 0.7, 1.5, -0.1,  0.0f,  1.0f,  0.0f,  // 18// 18
		 0.7, 1.5, -0.1,  0.0f,  1.0f,  0.0f ,  // 19 // 19

		// bottom
		- 0.7,  0.5, -0.1, 0.0f,  -1.0f,  0.0f, // 20// 20
		 0.7,  0.5, -0.1, 0.0f,  -1.0f,  0.0f , // 21 // 21
		 0.7,  0.5,  0.1, 0.0f,  -1.0f,  0.0f , // 22 // 22
		- 0.7,  0.5,  0.1, 0.0f,  -1.0f,  0.0f, // 23// 23
	};
...
void Demo::BuildTexturedCube()
{
	...
	float vertices[] = {
	   ...
	   // bottom
		- 0.7, -0.5, -0.5,  0.0f,  -1.0f,  0.0f, // 20
		0.7, -0.5, -0.5,    0.0f,  -1.0f,  0.0f,  // 21
		0.7, -0.5, 0.5,    20.0f,  -1.0f,  0.0f,  // 22
		-0.7, -0.5, 0.5,  20.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildTexturedFoto()
{
	...
	float vertices[] = {
		...
		// left
		-0.7,  0.5, -0.1,  -1.0f,  0.0f,  0.0f, // 12
		- 0.7,  0.5,  0.1,  -1.0f,  0.0f,  0.0f, // 13
		- 0.7,  1.5,    0.1,- 1.0f,  0.0f,  0.0f, // 14
		- 0.7,  1.5,   -0.1, - 1.0f,  0.0f,  0.0f, // 15

		// upper
		 0.7, 1.5,  0.1,  0.0f,  1.0f,  0.0f ,  // 16
		- 0.7, 1.5,  0.1,  0.0f,  1.0f,  0.0f , // 17
		- 0.7, 1.5, -0.1,  0.0f,  1.0f,  0.0f , // 18
		 0.7, 1.5, -0.1,  0.0f,  1.0f,  0.0f  , // 19

		// bottom
		- 0.7,  0.5, -0.1, 0.0f,  -1.0f,  0.0f ,// 20
		 0.7,  0.5, -0.1, 0.0f,  -1.0f,  0.0f  ,// 21
		 0.7,  0.5,  0.1, 0.0f,  -1.0f,  0.0f  ,// 22
		- 0.7,  0.5,  0.1, 0.0f,  -1.0f,  0.0f ,// 23
	};
